...
| Scroll stability | 100,000 logical rows x 50 columns | median frame interval while scrolling | provisional under 16.7 ms | repeated frames over 50 ms | CDP browser trace | Shell-enabled local three-process customization off/on medians: 16.620/16.599 ms; median p95 18.059/18.559 ms; no task over 50 ms; cross-hardware evidence open. |
